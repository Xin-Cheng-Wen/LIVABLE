...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_paths', type=str, nargs='+', default=['./train.jsonl'])
    parser.add_argument('--min_occ', type=int, default=1)
    parser.add_argument('-bin', '--save_model_dir', type=str, default='./diverse-wv_models')
    parser.add_argument('-n', '--model_name', type=str, default='diverse-train_subtoken_data')
